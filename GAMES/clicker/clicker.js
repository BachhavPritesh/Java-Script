...
function endGame() {
    ...
    if (current >= high) {
        ...
        high = current;
        displayMessage();
        statuMsg("🎉 Great job! Your score is higher than the previous one! 🏆" + " And Your click per second is : " + cps);
        videoC.style.display = 'block';

    } else {
        statuMsg("😕 Oops! Your score is lower than your high score. Try again! 💪" + "And Your click per second is : " + cps);
    }
